...
int main(){
  ...
  TFile *f = new TFile("../output_L1L1/cutPlots.root");
  TFile *f1 = new TFile("../finalZvM.root");
  TFile *fout = new TFile("../output_L1L1/outputFits.root","RECREATE");
  gROOT->SetBatch(true);
  ...
  canvas->SetLogy();
  std::string pdf_file_name = "../output_L1L1/vertexSliceFits.pdf";
  ...
  gxS->Draw("lsame");
  kk1->Update();
  kk1->SaveAs("../output_L1L1/zVm_zCut.C");
  kk1->Close();
  ...
  gx2->Draw("");
  kk2->Update();
  kk2->SaveAs("../output_L1L1/par3_zCut.C");
  kk2->Close();
  ...
  gx3->Draw("");
  kk3->Update();
  kk3->SaveAs("../output_L1L1/par4_zCut.C");
  kk3->Close();
