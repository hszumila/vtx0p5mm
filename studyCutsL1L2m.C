...
void studyCutsL1L2m(){
  ...
  TFile *fout = new TFile("../output_L1L2/ub/wiggleCutsM.root","RECREATE");
  std::string pdf_file_name = "../output_L1L2/ub/wiggleCutsM.pdf";
  gROOT->SetBatch(true);
