...
int main(){
  ...
  TFile *fout = new TFile("../output_L1L2/cutPlots.root","RECREATE");

  //cuts listed in order
  TCut cut1 = "((eleHasL1&&!posHasL1&&abs(posFirstHitY-100*posPY/posP)<1.5)||(posHasL1&&!eleHasL1&&abs(eleFirstHitY-100*elePY/eleP)<1.5))&&eleHasL2&&posHasL2&&uncP>0.845&&isPair1";
  ...
  TCut cut14 = "abs(elePhiKink2)<0.002&&abs(posPhiKink2)<0.002&&abs(elePhiKink1)<0.0001&&abs(posPhiKink1)<0.0001&&abs(eleLambdaKink2)<0.004&&abs(posLambdaKink2)<0.004&&abs(elePhiKink3)<0.002&&abs(posPhiKink3)<0.002&&abs(posLambdaKink3)<0.004&&abs(eleLambdaKink3)<0.004";
  ...
  tt->Draw("uncM>>h_m3",cut1 && cut2 && cut3);
  ...
  tt->Draw("uncM>>h_m4",cut1 && cut2 && cut3 && cut4);
  ...
  tt->Draw("uncM>>h_m5",cut1 && cut2 && cut3 && cut4 && cut5);
  ...
  tt->Draw("uncM>>h_m6",cut1 && cut2 && cut3 && cut4 && cut5 && cut6);
  ...
  tt->Draw("uncM>>h_m7",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7);
  ...
  tt->Draw("uncM>>h_m8",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8);
  ...
  tt->Draw("uncM>>h_m9",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut9);
  ...
  tt->Draw("uncM>>h_m10",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut9 && cut10);
  ...
  tt->Draw("uncM>>h_m11",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut9 && cut10 && cut11);
  ...
  tt->Draw("uncM>>h_m12",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut9 && cut10 && cut11 &&cut12);
  ...
  tt->Draw("uncM>>h_m13",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut9 && cut10 && cut11 && cut12 &&cut13);
  ...
  //cuts on tails of kinks
  tt->Draw("uncVZ>>h_z14",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut9 && cut10 && cut11 && cut12&&cut13 && cut14);
  tt->Draw("uncM>>h_m14",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut9 && cut10 && cut11 && cut12 &&cut13 && cut14);
  tt->Draw("(eleClT-posClT)>>h_tdiff14",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut9 && cut11 &&cut12 &&cut13 && cut14);
  signal[13] = h_z14->Integral(h_z14->FindBin(-5),h_z14->FindBin(7));
  background[13] = h_z14->Integral(h_z14->FindBin(-5),h_z14->FindBin(85))-signal[11];
  cout<<"cut 14"<<endl;
  /////////////////
  ...
  tt->Draw("uncVY:uncVX>>h_yvx",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut9 && cut10 && cut11 && cut12 && cut13&& cut14);
  
  //plot vy:mass
  TH2F *h_yvm = new TH2F("h_yvm","y vtx vs mass",300,0,0.1,300,-3,3);
  tt->Draw("uncVY:uncM>>h_yvm",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut9 && cut10 && cut11 && cut12 && cut13&& cut14);
  
  //plot vx:mass
  TH2F *h_xvm = new TH2F("h_xvm","x vtx vs mass",300,0,0.1,300,-3,3);
  tt->Draw("uncVX:uncM>>h_xvm",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut9 && cut10 && cut11 && cut12 && cut13&& cut14);

  //plot vz:mass
  TH2F *h_zvm = new TH2F("h_zvm","z vtx vs mass",400,0,0.1,400,-100,100);
  tt->Draw("uncVZ:uncM>>h_zvm",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut9 && cut10 && cut11 && cut12 && cut13&& cut14);
  ...
  h_tdiff14->SetLineColor(kViolet+6);
  h_tdiff14->SetLineWidth(2);
  ...
  h_tdiff13->Draw("same");
  h_tdiff14->Draw("same");
  ltime->AddEntry("h_tdiff1","L1L2","l");
  ...
  ltime->AddEntry("h_tdiff13","+shared hits<5","l");
  ltime->AddEntry("h_tdiff14","+kink cuts","l");
  ltime->Draw();
  ctime->Update();
  ctime->SaveAs("../output_L1L2/tdiff_cuts.C");
  ctime->Close();
  ...
  h_z14->SetLineColor(kViolet+6);
  h_z14->SetLineWidth(2);
  ...
  lzvtx->AddEntry("h_z13","+shared hits<5","l");
  lzvtx->AddEntry("h_z14","+kink cuts","l");
  lzvtx->Draw();
  czvtx->Update();
  czvtx->SaveAs("../output_L1L2/zvtx_cuts.C");
  czvtx->Close();
  ...
  lmass->AddEntry("h_m13","+shared hits<5","l");
  lmass->AddEntry("h_m14","+kink cuts","l");
  lmass->Draw();
  cmass->Update();
  cmass->SaveAs("../output_L1L2/mass_cuts.C");
  cmass->Close();
 ...
 h_zvm->Draw("colz");
 vertex->Update();
 vertex->SaveAs("../output_L1L2/vertex_cuts.C");
 vertex->Close();
 ...
 tt->Draw("eleTrkChisq>>h_trkChi2_post",cut1 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut9 && cut10 && cut11&& cut12 && cut13 && cut14);
 tt->Draw("posTrkChisq>>h_trkChi2_post",cut1 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut9 && cut10 && cut11&& cut12 && cut13&& cut14);
 TH1F *h_trkChi2_z = new TH1F("h_trkChi2_z","zvtx",200,-100,100);
 tt->Draw("uncVZ>>h_trkChi2_z",cut1 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut9 && cut10 && cut11&& cut12 && cut13&& cut14);

 TH1F *h_eleMom_post = new TH1F("h_eleMom_post","e- momentum",200,0,1.3);
 tt->Draw("eleP>>h_eleMom_post",cut1 && cut2 && cut4 && cut5 && cut6 && cut7 && cut8 && cut9 && cut10 && cut11&& cut12 && cut13&& cut14);
 TH1F *h_eleMom_z = new TH1F("h_eleMom_z","zvtx",200,-100,100);
 tt->Draw("uncVZ>>h_eleMom_z",cut1 && cut2 && cut4 && cut5 && cut6 && cut7 && cut8 && cut9 && cut10 && cut11&& cut12 && cut13&& cut14);

 TH1F *h_bscChi2_post = new TH1F("h_bscChi2_post","bsc chi2",200,0,30);
 tt->Draw("bscChisq>>h_bscChi2_post",cut1 && cut2 && cut3 && cut4 && cut6 && cut7 && cut8 && cut9 && cut10 && cut11&& cut12 && cut13&& cut14);
 TH1F *h_bscChi2_z = new TH1F("h_bscChi2_z","zvtx",200,-100,100);
 tt->Draw("uncVZ>>h_bscChi2_z",cut1 && cut2 && cut3 && cut4 && cut6 && cut7 && cut8 && cut9 && cut10 && cut11&& cut12 && cut13&& cut14);

 TH1F *h_bmuChi2_post = new TH1F("h_bmuChi2_post","bsc - unc chi2",200,0,20);
 tt->Draw("(bscChisq-uncChisq)>>h_bmuChi2_post",cut1 && cut2 && cut3 && cut4 && cut5 && cut7 && cut8 && cut9 && cut10 && cut11&& cut12 && cut13&& cut14);
 TH1F *h_bmuChi2_z = new TH1F("h_bmuChi2_z","zvtx",200,-100,100);
 tt->Draw("uncVZ>>h_bmuChi2_z",cut1 && cut2 && cut3 && cut4 && cut5 && cut7 && cut8 && cut9 && cut10 && cut11 && cut12 && cut13 && cut14);
 ...
 tt->Draw("abs(eleP-posP)/(eleP+posP)>>h_momAsy_post",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut9 && cut10&& cut12 && cut13&& cut14);
 tt->Draw("abs(eleP-posP):uncP>>h_pSumDiff_post",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut9 && cut10 && cut12 && cut13 && cut14);
 TH1F *h_momAsy_z = new TH1F("h_momAsy_z","zvtx",200,-100,100);
 tt->Draw("uncVZ>>h_momAsy_z",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut9 && cut10 && cut12 && cut13&& cut14 );

 TH1F *h_zvtxPeak = new TH1F("h_zvtxPeak",";z vertex +/-2ns cluster time diff",100,-100,100);
 tt->Draw("uncVZ>>h_zvtxPeak",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut11 && cut12 && cut13 &&"abs(eleClT-posClT)<1"&& cut14);
 TH1F *h_zvtxAcc = new TH1F("h_zvtxAcc",";z vertex >+/-2ns cluster time diff",100,-100,100);
 tt->Draw("uncVZ>>h_zvtxAcc",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut11 && cut12 && cut13&& cut14 &&"abs(eleClT-posClT)>3 && abs(eleClT-posClT)<5");
 TH2F *h_zVmPeak = new TH2F("h_zVmPeak","Within +/- 2ns cluster time diff;mass [GeV];z vertex [mm]",200,0,0.1,200,-100,100);
 tt->Draw("uncVZ:uncM>>h_zVmPeak",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut11 && cut12 && cut13 &&"abs(eleClT-posClT)<2");
 TH2F *h_zVmAcc = new TH2F("h_zVmAcc","> +/- 2ns cluster time diff; mass [GeV];z vertex [mm]",200,0,0.1,200,-100,100);
 tt->Draw("uncVZ:uncM>>h_zVmAcc",cut1 && cut2 && cut3 && cut4 && cut5 && cut6 && cut7 && cut8 && cut11 && cut12 && cut13 && "abs(eleClT-posClT)>3 && abs(eleClT-posClT)<9");
 ...
 llz->Draw();
 ccz->Update();
 ccz->SaveAs("../output_L1L2/zVertexCutEffects.C");
 ccz->Close();

 

 //Plot the change in number of events from cuts in the peak versus the background
 std::fstream myfile("../output_L1L2/cutEffects.txt", std::ios_base::out);
 ...
 eff->Draw("ap");
 ccr->Update();
 ccr->SaveAs("../output_L1L2/cutEfficiencies.C");
 ccr->Close();
 ...
 llzs->Draw();
 cczs->Update();
 cczs->SaveAs("../output_L1L2/zVertexAccidentals.C");
 cczs->Close();
